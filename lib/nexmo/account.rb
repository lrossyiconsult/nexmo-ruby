...
module Nexmo
  class Account < Namespace
    ...
    #
    # @option params [String] :moCallBackUrl The URL where Nexmo will send a webhook when an SMS is received to a Nexmo number that does not have SMS handling configured
    # @option params [String] :drCallBackUrl The URL where Nexmo will send a webhook when an delivery receipt is received without a specific callback URL configured
    #
    # @param [Hash] params
    #
    # @return [Entity]
